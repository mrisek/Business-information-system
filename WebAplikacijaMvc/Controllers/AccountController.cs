    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //unesi korisničke podatke u bazu podataka - tablica Korisnik
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "insert Korisnik values('" + model.Ime + "', '" + model.Prezime + "', '" + model.Email + "', 0, '" + model.UserName + "');";
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
